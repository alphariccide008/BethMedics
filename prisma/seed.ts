...
const products = [
  {
    ...
    stock: 150,
    sku: 'BM-SUP-001',
    tags: ['omega-3', 'heart health', 'supplements'],
    featured: true,
  },
  {
  ...
  },
  {
    ...
    stock: 45,
    sku: 'BM-DEV-001',
    tags: ['blood pressure', 'monitor', 'diagnostic'],
    featured: true,
  },
  {
  ...
  },
  {
    ...
    stock: 75,
    sku: 'BM-DEV-003',
    tags: ['thermometer', 'fever', 'diagnostic'],
    featured: false,
  },
  {
    ...
    stock: 90,
    sku: 'BM-SUP-004',
    tags: ['collagen', 'skin health', 'joints'],
    featured: false,
  },
  {
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?w=600'],
    category: 'Diagnostics',
    brand: 'BethMedic Pro',
    stock: 60,
    sku: 'BM-DX-001',
    tags: ['glucose', 'diabetes', 'blood sugar'],
    featured: true,
  },
  {
...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: process.env.ADMIN_EMAIL || 'admin@bethmedic.com' },
    update: {},
    create: {
      name: 'Beth (Founder)',
      email: process.env.ADMIN_EMAIL || 'admin@bethmedic.com',
      password: adminPassword,
      role: 'ADMIN',
      phone: '+1-800-BETHMEDIC',
    },
  });
